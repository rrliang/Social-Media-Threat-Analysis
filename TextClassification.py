...
class TextClassification:
    ...
    @staticmethod
    def check_dir():
        folders = ['Outputs/Pickled', 'Outputs/ROC', 'Outputs/Accuracy', 'Outputs/Lime', 'Outputs/Wordcloud']
    ...
    def naive_bayes(self, naive_bayes, naive_bayes_type):
        ...
        with open('Outputs/Pickled/' + naive_bayes_type + '_model', 'wb') as f:
        ...
        plt.savefig('Outputs/Accuracy/train_and_test_accuracy_' + naive_bayes_type)
        plt.clf()
        ...
        plt.savefig('Outputs/ROC/ROC_curve_' + naive_bayes_type)
        plt.clf()
        ...
        lime_exp.save_to_file('Outputs/Lime/lime_' + naive_bayes_type + '.html')

        lime_exp.as_pyplot_figure()
        plt.savefig('Outputs/Lime/lime_' + naive_bayes_type + '_bargraph')
        plt.clf()
